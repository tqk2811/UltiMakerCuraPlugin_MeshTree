...
class OverhangSupportPlugin(QObject, Extension):
    ...
    def __init__(self, parent=None):
        ...
        prefs.addPreference(_PREF_ANGLE,        40)
        prefs.addPreference(_PREF_SPACING,       2.6)
        prefs.addPreference(_PREF_DIAM,          0.3)
        prefs.addPreference(_PREF_OFFSET,        0.15)
        prefs.addPreference(_PREF_SHOW_OVERLAY, True)

        prefs.addPreference(_PREF_TREE_ANGLE,    25)
        prefs.addPreference(_PREF_TREE_BASE,     25)
        prefs.addPreference(_PREF_TREE_PER_LVL,   7)
        prefs.addPreference(_PREF_TREE_GROWTH,     20)
